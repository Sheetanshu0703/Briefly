...
from Briefly.pipeline.stage_04_model_trainer import ModelTrainerTrainingPipeline
from Briefly.pipeline.stage_05_model_evaluation import ModelEvaluationTrainingPipeline
